...
p_total = p_lineal*p_cuadra1*p_cuadra2;
...
bodeplot(p_total, 'b', pt_total, 'r', P)
...
alpha1 = Q1^(-1);
refC5_1 = 1*10^-9;        % 1nF
refC2_1 = 560*10^-9;      % 560nF

[R1_cuadr1, C2_cuadr1, R3_cuadr1, R4_cuadr1, C5_cuadr1] = lp_reaMult(Ho1, alpha1, wo1, refC5_1, refC2_1);
...
alpha2 = Q2^(-1);
refC5_2 = 2.2*10^-9;     % 2.2nF
refC2_2 = 39*10^-9;      % 39nF

[R1_cuadr2, C2_cuadr2, R3_cuadr2, R4_cuadr2, C5_cuadr2] = lp_reaMult(Ho2, alpha2, wo2, refC5_2, refC2_2);
